...
namespace Unity.FPS.AI
{
    ...
    public class EnemyEscape : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<EnemyController, EnemyEscape>(m_EnemyController, this,
                gameObject);
            ...
            DebugUtility.HandleErrorIfNullGetComponent<AudioSource, EnemyEscape>(m_AudioSource, this, gameObject);
